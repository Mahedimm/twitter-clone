import {
    ...
    ClipboardListIcon, DotsCircleHorizontalIcon, HashtagIcon, InboxIcon, UserIcon
...
const Sidebar = () => {
    ...
    return (
        ...
        <div className="flex items-center justify-center w-14 h-14 hoverAnimation p-0 xl:ml-24">
            <Image src="https://rb.gy/ogau5a" width={30} height={30} alt="twitter"/>
        </div>
        ...
        <div  className="text-[#d9d9d9] flex items-center justify-center   hoverAnimation xl:ml-auto mt-auto">
            <img src={session.user.image}  alt={session.user.name.charAt(0)}className="h-10 w-10 rounded-full xl:mr-2.5 "/>
